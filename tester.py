...
def fetch_html_content(url):
    ...
    if response.status_code == 200:
        ...
        #soup = soup.prettify()
          # Print the prettified soup for debugging
        return soup
    else:
...
def insert_observations(conn, headers, rows):
    c = conn.cursor()
    for row in rows:
        #row[0] = datetime.strptime(row[0], '%I:%M %p').strftime('%H:%M:%S')
...
def save_all_data_to_spreadsheet(conn, filename='Erie2.xlsx', start_row=7, start_col=2):
...
# URL to fetch -- neeeds to be updated daily. 
url = 'https://www.wunderground.com/dashboard/pws/KCOLONGM274/table/2024-11-21/2024-11-21/daily'
url = "https://www.wunderground.com/dashboard/pws/KCOLAFAY139/table/2024-11-21/2024-11-21/daily"
url = "https://www.wunderground.com/dashboard/pws/KCOBROOM347/table/2024-12-07/2024-12-07/daily"
...
save_all_data_to_spreadsheet(conn, filename='Erie3.xlsx', start_row=7, start_col=2)
